...
For~$a, b \ge 2$ define the \defn{$(a,b)$-sashes congruence}~$\equiv_{\textrm{sh}(a,b)}$ by the ideal~$\arcs_{\textrm{sh}(a,b)}$ of arcs which do not pass above $a$ consecutive points, nor below $b$ consecutive points.
...
The $(2,2)$-sashes congruence was studied in~\cite{LaniniNovelli} and its equivalence classes are counted by central binomial coefficients.
...
k \backslash n & 1 & 2 & 3 & 4 & 5 & 6 &  \dots \\
\hline
1 & 1 & 1 & 1 &   1 &     1 & 1 & \dots\\
2 &    & 2 & 6 & 14 &   30 & 62 & \dots \\
3 &    &    & 8 & 46 & 184 & 638 & \dots\\
...
\vdots &&&&&& & \ddots \\
\hline
\Sigma & 1 & 3 & 15 & 103 & 867 & 8499 & \dots
\end{array}
\]
\end{remark}
