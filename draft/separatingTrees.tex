...
\begin{example}
For instance, the four separating trees of \cref{fig:separatingTrees} have the following mandatory arcs:
\[
...
(2, 3, \varnothing, \varnothing) &
(2, 5, \{3\}, \{4\}) &
(3, 4, \varnothing, \varnothing) &
(3, 4, \varnothing, \varnothing)
\\
(4, 5, \varnothing, \varnothing) &
(3, 5, \varnothing, \{4\}) &
(4, 5, \varnothing, \varnothing) &
(3, 5, \varnothing, \{4\})
\\
...
\\
(6, 7, \varnothing, \varnothing) &
(6, 7, \varnothing, \varnothing) &
(6, 7, \varnothing, \varnothing) &
(6, 7, \varnothing, \varnothing)
\end{array}
\]
and the following forbidden arcs:
\[
\begin{array}{c@{\qquad}|@{\qquad}c@{\qquad}|@{\qquad}c@{\qquad}|@{\qquad}c}
\;\;(3, 5, \varnothing, \{4\})\;\; &
\;\;(4, 6, \{5\}, \varnothing)\;\; &
...
Aa a follow-up of \cref{rem:separatingTreesVSPermutrees}, note that any separating tree appears in at least one permutree congruence.
\vincent{todo}
\end{remark}
