...
\begin{remark}
As already observed in~\cite[Sect.~4.4]{HoangMutze}, the number of essential simple congruences of the weak order on~$\f{S}_n$ is~$C_{n-1}^2$, where~$C_n \eqdef \frac{1}{n+1} \binom{2n}{n}$ is the Catalan number.
...
If~$\equiv$ is an essential simple congruence of the weak order, then the Hasse diagram of any $\equiv$-poset is a separating tree.
\end{proposition}
