...
A lattice congruence~$\equiv$ of the weak order is \defn{simple} if all maximal (in the arc poset) arcs of~$\arcs_n \ssm \arcs_\equiv$ are up arcs or down arcs.
\end{definition}
...
Moreover, as $T$ is the contraction of~$J_\circ \to J_\bullet$ in~$S$, we have~$I = I'$ or~$I \in \{J_\circ, J_\bullet\}$ and~$I' = J_{\circ\bullet}$ and similarly for~$K$ and~$K'$.
We distinguish four cases:
\begin{itemize}
\item If~$I = I'$ and~$K = K'$, then $I' \cup K' = I \cup K$ so that~${]i,k[} \cap (I' \cup K') = {]i,k[} \cap (I \cup K) = \varnothing$.
\item If~$I \ne I'$ and~$K \ne K'$, then~$I' = J_{\circ\bullet} = K'$. If~$I \ne K$, then~$I \cup K = J_{\circ\bullet} = I' \cup K'$ so that~${]i,k[} \cap (I' \cup K') = {]i,k[} \cap (I \cup K) = \varnothing$. If~$I = K = J_\circ$, then~${]i,k[} \subseteq J_\circ$, so that~${]i,k[} \cap (I' \cup K') = {]i,k[} \cap J_{\circ\bullet} = {]i,k[} \cap J_\circ = {]i,k[} \cap (I \cup K) = \varnothing$. Idem if~$I = K = J_\bullet$.
\item If~$I \ne I'$ and~$K = K'$, then~$I-K$ form an edge of~$T$. Assume for instance that~$I = J_\circ$ (the case~$I = J_\bullet$ is symmetrical). If the edge~$J_\circ-K$ of $T$ is oriented~$J_\circ \to K$, then~$K < \max(J_\circ)$ so that~${]i,k[} \cap J_\bullet = \varnothing$, hence~${]i,k[} \cap (I' \cup K') = {]i,k[} \cap (J_{\circ\bullet} \cup K) = {]i,k[} \cap (J_\circ \cup K) = {]i,k[} \cap (I \cup K) = \varnothing$. If the edge~$J_\circ-K$ of $T$ is oriented~$J_\circ \leftarrow K$, then
\vincent{todo: I have a problem here...}
\end{itemize}
%
%
%If~$I = I'$ and~$K = K'$, or if~$I' = K' = I \cup K = J_{\circ\bullet}$, then we have~$I' \cup K' = I \cup K$.
%Otherwise, we can assume by symmetry that~$I = J_\circ$, $I' = J_{\circ\bullet}$, and~$K = K' \ne J_{\circ\bullet}$.
%
%
%if~$I \ne I'$ or~$K \ne K'$, we have either~$I' = K' = I \cup K = J_{\circ\bullet}$ or~$I' = J_{\circ\bullet} \ne K = K'$ or~${I = I' \ne J_{\circ\bullet} = K'}$.
%In the first case, ${]i,k[} \cap (I' \cup K') = {]i,k[} \cap (I \cup K) = \varnothing$.
%In the second case, assume for instance that~$I = J_\circ$ (the case where~$I = J_\bullet$ is symmetric).
%
%
%
%since~$I$ and~$K$ form an edge of~$T$, we obtain by construction of~$T$ that~$I = J_\circ$ and~$K < \max(J_\circ) < \min(J_\bullet)$ or~$I = J_\bullet$ and~$K \not< \max(J_\circ)$, from which we deduce that~$I' \cup K' = J_{\circ\bullet} \cup K = I \cup K$, hence~${]i,k[} \cap (I' \cup K') = {]i,k[} \cap (I \cup K) = \varnothing$.
...
Consider now a node~$J$ of~$T$ with two ancestor subtrees~$L$ and~$R$ with~$L < R$, and let~$M \eqdef \max(L)$ and~$m \eqdef \min(R)$.
\vincent{todo: I have a problem here...}
\end{proof}
